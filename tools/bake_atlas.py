...
# ── the coins-&-kitchens pass: forage, tilled soil, and the ripe crops ──────
# A bramble heavy with hedge-berries — deliberately unlike the BERRY_BUSH and
# BUSH_FRUIT decor that dots ordinary Tile::Bush, so a pickable patch reads
...
# A clutch of golden chanterelles — the pickable mushrooms. The woods'
# everyday decor scatters red-capped singles everywhere, so the forage had
# to be a color nothing else on the forest floor wears.
CHANTERELLES = """
................
................
................
...
# A tilled garden plot: dark turned earth in furrow rows, the odd pale stone.
SOIL = """
bbbbbbbbbbbbbbbb
btbbbbbLbbbbbtbb
BBBBBBBBBBBBBBBB
...
# A turnip come good: proud greens, a pale bulb shouldering out of the row.
TURNIP_RIPE = """
................
......G.g.......
....g.Ggg.g.....
...
# And a pumpkin, small, round, and very pleased with itself.
PUMPKIN_RIPE = """
................
.......3B.......
......33........
...
PALETTE = {
    ...
    "f": (247, 76, 0, 255),
    "F": (165, 43, 0, 255),
    # Dark hedge leaf, for the berry bramble's shaded side.
    "d": (74, 110, 66, 255),
}
...
def main(sheet_path, chars_path):
    ...
    cells = [
        ...
        *[
        ...
        # ── coins & kitchens: the pickable berry bramble, tilled garden
        # soil, and the crops that come good on the campfire clock ──
        ("BERRY_LADEN", from_art(BERRY_LADEN, PALETTE)),
        ("SOIL", from_art(SOIL, PALETTE)),
        ("TURNIP_RIPE", from_art(TURNIP_RIPE, PALETTE)),
        ("PUMPKIN_RIPE", from_art(PUMPKIN_RIPE, PALETTE)),
        ("CHANTERELLES", from_art(CHANTERELLES, PALETTE)),
    ]
